...
(defcustom fixme-error-highlighted-words '("FIXME" "BUG")
  "Words to highlight"
  :group 'fixme-mode)

(defcustom fixme-foreground-color "White"
  "Font foreground colour"
  :group 'fixme-mode)

(defcustom fixme-background-color  "Blue"
  "Font background color"
  :group 'fixme-mode)

(defcustom fixme-error-foreground-color "Yellow"
  "Font foreground colour"
  :group 'fixme-mode)

(defcustom fixme-error-background-color  "Red"
  "Font background color"
  :group 'fixme-mode)
...
and store the result in fixme-keyword-font-lock"
  ...
  (lexical-let ((error-stuff '()))
    ...
    (setq fixme-error-keyword-font-lock error-stuff)))
