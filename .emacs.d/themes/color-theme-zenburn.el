...
(defvar zenburn-bg "#080808")
(defvar zenburn-bg+1 "#4f4f4f")
(defvar zenburn-bg+2 "#5f5f5f")
(defvar zenburn-red+1 "#d65c5c")
(defvar zenburn-red "#cc6262")
(defvar zenburn-red-1 "#bc6262")
(defvar zenburn-red-2 "#ac5252")
(defvar zenburn-red-3 "#9c3b3b")
(defvar zenburn-red-4 "#8c3434")
(defvar zenburn-orange "#de8d57")
(defvar zenburn-orange+1 "#ed985f")
(defvar zenburn-yellow "#f0d999")
(defvar zenburn-yellow-1 "#e0cc80")
(defvar zenburn-yellow-2 "#d0bc80")
(defvar zenburn-green-1 "#4c7c4c")
(defvar zenburn-green "#6d9d6d")
(defvar zenburn-green+1 "#76b376")
(defvar zenburn-green+2 "#7ec47e")
(defvar zenburn-green+3 "#87d687")
(defvar zenburn-green+4 "#91eb91")
(defvar zenburn-cyan "#88e0e3")
(defvar zenburn-blue+1 "#80bff3")
(defvar zenburn-blue "#77d0d3")
(defvar zenburn-blue-1 "#70b8bb")
(defvar zenburn-blue-2 "#5da0a3")
(defvar zenburn-blue-3 "#4d888b")
(defvar zenburn-blue-4 "#417073")
(defvar zenburn-magenta "#db74bb")
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
     ...
     '(zenburn-primary-3 ((t (:foreground "#deabab" :weight bold))))
     '(zenburn-primary-4 ((t (:foreground "#db8c8c" :weight bold))))
     '(zenburn-primary-5 ((t (:foreground "#74adf2" :weight bold))))

     '(zenburn-highlight-damp
       ((t (:foreground "#7fb090" :background "#252927"))))
     '(zenburn-highlight-alerting
       ((t (:foreground "#e35e5d" :background "#2e1d1d"))))
     '(zenburn-highlight-subtle
       ((t (:background "#525252"))))

     '(zenburn-lowlight-1 ((t (:foreground "#707070"))))
     '(zenburn-lowlight-2 ((t (:foreground "#6d856d"))))
     ...
     `(zenburn-paren-1 ((t (:foreground ,zenburn-blue :background ,zenburn-green-1))))
     ...
     '(paren ((t (:inherit zen-lowlight-1))))
     '(show-paren-mismatch ((t (:inherit font-lock-warning))))
     '(show-paren-match ((t (:inherit zenburn-paren-1))))
     '(match ((t (:weight bold))))
